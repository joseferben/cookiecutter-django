...
ssh -t dokku@lettuce redis:link --no-restart {{cookiecutter.project_slug}}-redis {{cookiecutter.project_slug}}
...
ssh -t dokku@lettuce ps:restart {{cookiecutter.project_slug}}
